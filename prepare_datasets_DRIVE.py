...
if fine_tuning=="False":
    ...
    #------------Path of the images for finetuning ----------------------------------------------
    #train
    original_imgs_train = "./Fine_tuning_data/training/images/"
    groundTruth_imgs_train = "./Fine_tuning_data/training/1st_manual/"
    borderMasks_imgs_train = "./Fine_tuning_data/training/mask/"
    #test
    original_imgs_test = "./Fine_tuning_data/test/images/"
    groundTruth_imgs_test = "./Fine_tuning_data/test/1st_manual/"
    borderMasks_imgs_test = "./Fine_tuning_data/test/mask/"
    #Destination
    dataset_path = "./DRIVE_datasets_training_testing/"
    Nimgs = 7
    channels = 3
